...
<html>
    ...
    <div class="topnav">
        ...
        <div class="topnav-right">
            ...
            <a class="active" href="{{action('MainController@message')}}"><span class="glyphicon glyphicon-envelope" style = "color:white;margin : 3px;" ></span>Messages</a>
        ...
        <div class="mesgs">
          <div class="msg_history">
            ...
            <div class="incoming_msg">
              ...
              <div class="received_msg">
                ...
                <p>{{$message->body}}</p>
                  <span class="time_date">{{date('F-d-Y', strtotime($message->sentDate))}}</span></div>
              </div>
            </div>
            @endif
          ...
          <div class="type_msg">
            <div class="input_msg_write">
                ...
                <input type="hidden" class="write_msg" name="recieverId" value="{{$selected}}" placeholder="Type a message" />
